...
SELECT user_audios.id, user_audios.created_at, user_id, audio_id, audios.id, audios.created_at, title, author, duration_ms, path, size_bytes, youtube_video_id, thumbnail_path, spotify_id, thumbnail_url, local_id, playlist_audio_count, user_audio_count FROM user_audios
  INNER JOIN audios ON user_audios.audio_id = audios.id
